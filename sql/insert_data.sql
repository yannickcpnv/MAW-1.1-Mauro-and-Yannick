...
REPLACE INTO `answers` (`take_id`, `question _id`, `value`) VALUES
	(1, 2, 'I\'m here POG'),
...
REPLACE INTO `exercises` (`id`, `title`, `exercise_status_id`) VALUES
	(1, 'Exercise 1', 0),
	(2, 'Exercise Building', 0),
	(3, 'Exercise Answering', 1),
	(4, 'Exercise Closed', 2);
/*!40000 ALTER TABLE `exercises` ENABLE KEYS */;

-- Dumping data for table looper.exercise_statuses: ~3 rows (approximately)
/*!40000 ALTER TABLE `exercise_statuses` DISABLE KEYS */;
REPLACE INTO `exercise_statuses` (`id`, `name`) VALUES
	(0, 'Building'),
	(1, 'Answering'),
	(2, 'Closed');
/*!40000 ALTER TABLE `exercise_statuses` ENABLE KEYS */;

-- Dumping data for table looper.questions: ~0 rows (approximately)
/*!40000 ALTER TABLE `questions` DISABLE KEYS */;
REPLACE INTO `questions` (`id`, `label`, `exercise_id`, `question_type_id`) VALUES
	(1, 'Question to answer', 3, 0),
...
REPLACE INTO `takes` (`id`, `timestamp`) VALUES
	(1, '2021-09-10 11:16:58'),
